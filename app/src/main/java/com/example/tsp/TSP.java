...
public class TSP {
    ...
    private int[] ciclo(){
        ...
        for(int z = 0; z < 100000; z++){
            ...
            do{ padre2Pos = seleccionTorneo(); } while(padre1Pos == padre2Pos);
            ...
            if(currPM < pM){
                ...
                do{ pos2 = ((int)(Math.random() * numLugares) % (numLugares - 1)) + 1; } while(pos1 == pos2);
            ...
            switch (pos[0]) {
                case 0: rutas[padre1Pos] = padre1; break;
                case 1: rutas[padre1Pos] = padre2; break;
                case 2: rutas[padre1Pos] = hijo1; break;
                case 3: rutas[padre1Pos] = hijo2; break;
            }

            // Seleccionar el segundo mejor para el padre2
            switch (pos[1]) {
                case 0: rutas[padre2Pos] = padre1; break;
                case 1: rutas[padre2Pos] = padre2; break;
                case 2: rutas[padre2Pos] = hijo1; break;
                case 3: rutas[padre2Pos] = hijo2; break;
            }
